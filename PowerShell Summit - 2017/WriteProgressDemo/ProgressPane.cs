...
namespace Microsoft.PowerShell
{
    ...
    class ProgressPane
    {
        private const string ProgressCommand = "progress";
        ...
        Show(PendingProgress pendingProgress)
        {
            ...
            using (ps)
            {
                ps.AddCommand(ProgressCommand);
                ps.AddParameter("RawUi", _rawui);
                ps.AddParameter("ProgressRecords", pendingProgress.TopLevelNodes);
            ...
            if (contents == null)
            {
                ...
                contents = pendingProgress.Render(maxWidth, maxHeight, _rawui);
            }
